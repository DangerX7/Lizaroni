...
public class b4_player_right_detect_script : MonoBehaviour
{
    ...
    IEnumerator CoroutineWait()
    {
        ...
        if (Boss4_1Reference.type == 0)
        {
            ...
            GameObject UpLimit = GameObject.Find("up player detect 0");
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            Debug.Log("PLAYER COLLIDED RIGHT!");
