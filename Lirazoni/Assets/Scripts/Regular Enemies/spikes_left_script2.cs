...
public class spikes_left_script2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if ((col.gameObject.tag.Equals("wall")) || (col.gameObject.tag.Equals("wall3")) || (col.gameObject.tag.Equals("Door2")) || (((col.gameObject.tag.Equals("wallLeft"))) && (secondaryWallCheck == true) && (isReverseTrue == false)) || (((col.gameObject.tag.Equals("wallRight"))) && (secondaryWallCheck == true) && (isReverseTrue == true)))
        {
            ...
            if (id == 0)
            {
                if (isReverseTrue == false)
                {
                    spike.transform.position -= left * (levelReference.levelColumns + mapDifference);
                }
                if (isReverseTrue == true)
                {
                    spike.transform.position += left * (levelReference.levelColumns + mapDifference);
            ...
            if (id == 1)
            {
                if (isReverseTrue == false)
                {
                    spike.transform.position -= left * (levelReference.levelColumnsV + mapDifference);
                }
                if (isReverseTrue == true)
                {
                    spike.transform.position += left * (levelReference.levelColumnsV + mapDifference);
