...
public class spikes_up_script2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if ((col.gameObject.tag.Equals("wall")) || (col.gameObject.tag.Equals("wall3")) || (col.gameObject.tag.Equals("Door2")) || (((col.gameObject.tag.Equals("wallUp"))) && (secondaryWallCheck == true) && (isReverseTrue == false)) || (((col.gameObject.tag.Equals("wallDown"))) && (secondaryWallCheck == true) && (isReverseTrue == true)))
        {
